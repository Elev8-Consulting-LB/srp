...
export default function ContactPage() {
  ...
  return (
    <main className="overflow-hidden">
      ...
      <motion.section className="bg-customTextFont">
        <div className="bg-customTextFont px-4 md:px-8 py-24 rounded-lg mb-8">
          ...
          <div className="bg-customTextFont px-4 md:px-8 py-24 rounded-lg mb-8 flex flex-col items-center justify-center">
              <motion.h3
                  className="text-2xl font-bold text-white mb-4 text-center relative"
                  whileHover={{ scale: 1.05 }}
                  transition={{ type: "spring", stiffness: 300 }}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-10 justify-center items-center text-white">
                  <ul className="flex flex-col items-start justify-center space-y-5 text-lg">
                      <li className="flex items-center space-x-4">
                          <Phone className="w-7 h-7 text-customSecondary text-opacity-80 transition-transform duration-200 hover:scale-110" />
                          <Link href="tel:+9613172799" className="hover:underline transition-colors duration-200 hover:text-customSecondary">
                              +961 3 17 27 99
                          </Link>
                      </li>
                      <li className="flex items-center space-x-4">
                  ...
                  <ul className="flex flex-col items-start justify-center space-y-5 text-lg">
                      <li className="flex items-center space-x-4">
                          <Mail className="w-7 h-7 text-customSecondary text-opacity-80 transition-transform duration-200 hover:scale-110" />
                          <Link href="mailto:clients@supremerecruitmentpartners.com" className="hover:underline transition-colors duration-200 hover:text-customSecondary">
                              clients@supremerecruitmentpartners.com
                          </Link>
                      </li>
                      <li className="flex items-center space-x-4">
                          <Globe className="w-7 h-7 text-customSecondary text-opacity-80 transition-transform duration-200 hover:scale-110" />
                          <Link href="https://www.supremerecruitmentpartner.com" target="_blank" className="hover:underline transition-colors duration-200 hover:text-customSecondary">
                              www.supremerecruitmentpartner.com
                          </Link>
                      </li>
                  </ul>
              </div>
